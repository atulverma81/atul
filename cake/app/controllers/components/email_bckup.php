...
class EmailComponent
{
   ...
   */
    var $from         = '';
    var $fromName     = "";
    var $smtpUserName = 'testsdei@smartdatainc.net';  // SMTP username
    var $smtpPassword = 'sdeichd'; // SMTP password
    var $smtpHostNames= "mail.smartdatainc.net";  // specify main and backup server
    var $text_body = null;
    var $html_body = null;
    var $to = null;
    var $toName = null;
