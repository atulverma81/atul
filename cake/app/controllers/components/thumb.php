<?php
 ...
 class ThumbComponent extends Object {
	...
	* @access public
	*/
	public $image_folder ="xray/bite-xray/";
	/**
	* Thumb image folder
	* @access public
	*/
	public $thumb_folder = "thumb-xray/bite-xray/";
	/**
	* image resource
	* @access public
	*/
	...
	**/
/*
	public function  __construct($img_options = NULL)
	{
	...
	public function isExists($image_name,$thumb = false)
	{
	...
	public function saveImage($filename,$thumb = true)
	{ 
		$res = null;
	...
	public function imageCreateFromType($filename) 
	{
 		$res = null;
...
// 		$filename = $this->image_folder."/".$filename;
	...
	public function  createThumbnail($from_file)
	{
...
// 	
	...
	function getResized($id, &$mime, $imgFolder, $newWidth=false, $newHeight=false, $bgcolor="#FFFFFF", $resample=true, $cache=false, $cacheFolder=false, $cacheClear=false, $tempFolder=false)
	{
		$img = $imgFolder . $id;
