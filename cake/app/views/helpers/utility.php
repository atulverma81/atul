...
function date_format($date = '',$type = 0){
	...
	/**
        * @method      : BindFrequency
        * @description : Used to bind frequency emum with actual words
        * @param       : $enum
        * return       : kewword
        **/
    function BindFrequency($enum){
	switch($enum){
		case '0':
		$keyword = 'One Time';
		case 'd':
	...
	/**
        * @method      : BindOrganizationSize
        * @description : Used to bind organization size with actual words
        * @param       : $enum
        * return       : kewword
        **/
 
    function BindOrganizationSize($enum){
	switch($enum){
		case '1':
		$keyword = 'Less than 25 members';
		break;
		case '2':
		$keyword = 'Between 25 and 50 members';
		break;
		case '3':
		$keyword = 'Between 50 and 100 members';
		break;
		case '4':
		$keyword = 'Between 100 and 250 members';
		break;
		case '5':
		$keyword = "Between 250 and 500 members";
		break;
		case '6':
		$keyword = "Between 500 and 1,000 members";
		break;
		case '7':
		$keyword = "More than 1000 members";
		break; 
		}
	return $keyword;
	}	
	...
	function getComments($eventId = null){
		...
		$allComments = $this->Comment->find('all',array('conditions'=>array('event_id'=>$eventId),'order'=>'posting_date DESC')); 
		return $allComments;	      
	    }
}//End class