...
Hello <b><?php echo $details['firstname']?> <?php echo $details['lastname']?>,</b>
<br><br>
You have requested for new password for your profile.
<br><br>
<b>Following are your new Account Details:</b><br>
<b>Email Id:</b> <?php echo $details['email']; ?><br>
Password: <?php echo $details['bck_password']; ?>
<br><br>
<b>After using the new password, we recommend you to change your password imidiately.</b>
<br><br>
<b>
Thanks & Regards<br>
LHR Support Team
