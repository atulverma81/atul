<?php echo $form->create('User',array('action'=>'setPassword','id'=>'formID','method'=>'POST','class'=>'formular','name'=>'frmCreateEvent') )?>   
 <!--Search Result Starts Here-->
	...
	<li> <?php  $session->flash(); ?>  <font class="requiredField">*</font> marked are mandatory</li>
        ...
        <ul class="login-fields">
            <li><p> Please change your password to something more memorable</p> </li>
