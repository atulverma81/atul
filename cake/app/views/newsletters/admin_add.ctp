...
<div  class="single" >
	<h2><img src="/img/users.gif" alt="Newsletters Management"> Newsletters Managment</h2>			 					 		
</div>
<div style="padding:2px">
 ...
 echo '<span class="mediumFontf">Add Newsletter<span>';
?>
 </div>               
...
<?php echo $form->create('Newsletter',array('action'=>'/add','name'=>'addnewsletter','onSubmit'=>'return validate_form(FRM_LABELS, FRM_CONTROLS, ERR_MESSAGES);'))?>
 ...
 <?php if($session->check('message')) { ?>
  ...
  <?php } ?>
	...
	<tr>
	  ...
	  <td>&nbsp;</td>
	  <td>
			<?php echo $form->submit('Add Newsletter',array('class'=>'button'))?>
		</td>
	</tr>
	</table>
