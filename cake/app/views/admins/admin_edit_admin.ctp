...
<?php  
 echo $html->link('Edit Admin Management','/admin/admins/index').' >> ';
 
 echo '<span class="mediumFontf">Edit Account<span>';
?>
 </div>               
...
<?php 
 echo $form->create('Admin',array('action'=>'edit','id'=>'formID','method'=>'POST','class'=>'formular','name'=>'addAdmin'));
?>
...
<tr>
	...
	<tr>
	 ...
	 <td><?php echo $form->submit('Update',array('class'=>'button'));?></td>
	</tr> </table>
