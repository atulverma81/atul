...
<?php  
 ...
 echo '<span class="mediumFontf">Add Banner<span>';
?>
...
<?php echo $form->create('Banner',array('action'=>'/add','name'=>'add','enctype'=>'multipart/form-data','onSubmit'=>'return validBanner();'))?>
...
<font color="red">*</font>Banner Description : </td>
	   <td>
	      <?php 
echo $form->input('Banner.content', array('class'=>'','cols'=>38,'label'=>'','div'=>false));
