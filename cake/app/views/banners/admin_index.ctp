...
<div id="content">
	...
	<?php  echo $html->link('Banner Management','/admin/banners/index').' >> ';
	echo '<span class="mediumFontf">View Banner Listing<span>'; ?>
	</div>
...
<?php
echo $form->create(NULL,array("url"=>"/admin/banners/index","method"=>"Post"));
?>
...
<?php echo $form->text('Banner.name', array('maxlength'=>'40'),null,null )?>
</td>
</tr>
...
<?php
echo $form->text('Banner.searchRecord', array('maxlength'=>'80','value'=>'records','type'=>'hidden','size'=>'30','label'=>'','id'=>'title','div'=>false));
?>
	<tr>
	      <td align="left">&nbsp;</td>
	      <td align="left" colspan="2">
<?php echo $ajax->submit(__("Search",true),array('div' => false,'class' => 'btn','url' => "/admin/banners/index",'update' =>'listID','indicator' =>'loaderID'));?>
               </td>
	</tr>
 </table>
       <?php echo $form->end();?>
...
<div style=" border:0px solid red; font-size:12px;  margin:20px 0px 0px 0px;  Color:#ff0000;">
 ...
 <?php echo $this->renderElement("admin/banners/index"); ?>
	</div>          